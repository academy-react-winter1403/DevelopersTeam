...
const GetNewsDetailList = () => {
  ...
  return (
    <div className="mt-10 h-[2000px] flex justify-around ">
      ...
      <div className="w-[750px] border border-red-400 h-[1800px]">
        ...
        <div className="border w-[738px] h-10 flex items-center gap-1 p-4">
