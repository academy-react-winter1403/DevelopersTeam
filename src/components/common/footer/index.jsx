...
const Footer = () => {
  ...
  return (
    <div className="w-11/12 h-auto  flex flex-col md:flex-row md:h-52 bg-lightGray dark:bg-gray-800 rounded-4xl mx-auto mb-10 space-y-7 lg:space-x-20">
      ...
      <div className=" w-72 mt-6 ml-6 h-40 order-5 hidden xl:block">
        <MapComponent />
      </div>
    </div>
  );
