...
const Item = ({ commentObj, isReplay }) => {
  ...
  return (
    <div className={` w-full m-2 ${isReplay && "space-x-3 "}`}>
      <div className="w-full flex my-2 ">
        {isReplay && (
          <div className="w-2 h-52 bg-navyBlue mr-10 dark:bg-blue-600 rounded-sm"></div>
        )}
        <div className="px-2">
          <div className="mt-2 ">
          ...
          <div className="flex p-4 gap-2 items-center">
            ...
            <button
              ...
              className="w-1/3  sm:w-4/12 h-10 whitespace-nowrap rounded-full text-xs sm:text-base text-navyBlue dark:text-blue-400 text-center border border-navyBlue dark:border-blue-400 leading-8"
            >
            ...
            <div
              onClick={() => setOpen((e) => !e)}
              className="text-[13px] text-center w-34 h-5  flex items-center space-x-2 cursor-pointer dark:text-gray-400"
            >
